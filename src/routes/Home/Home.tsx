...
import Yenweet from "routes/Home/components/Yenweet/Yenweet";
import YenweetFactory from "routes/Home/components/YenweetFactory/YenweetFactory";
...
const Home = ({ userObj }: HomeProps) => {
  ...
  return (
    <S.Container>
      <YenweetFactory userObj={userObj} />
      <S.YenweetContainer>
